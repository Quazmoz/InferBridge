...
**Current pre-release: `0.9.3-beta.1`.** Beta builds ship ahead of the next stable release and are marked pre-release on GitHub. Context budget visibility, model preparation recovery, and stage-aware preparation watchdogs are present only in the `0.9.x` beta artifacts; the published 0.8.0 release notes described those features, but they landed after the `v0.8.0` tag was cut. See [0.9.3-beta.1](docs/releases/0.9.3-beta.1.md) for transactional model conversion, strict converted-artifact validation, and uninterrupted device switching.

- [Windows installer](https://github.com/Quazmoz/InferBridge/releases/download/v0.9.3-beta.1/InferBridge-0.9.3-beta.1-windows-x64-installer.exe)
- [Portable ZIP](https://github.com/Quazmoz/InferBridge/releases/download/v0.9.3-beta.1/InferBridge-0.9.3-beta.1-windows-x64-portable.zip)
- [SHA-256 checksums](https://github.com/Quazmoz/InferBridge/releases/download/v0.9.3-beta.1/InferBridge-0.9.3-beta.1-checksums.txt)
